...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class NetworkTab : Control
    {
        ...
        public NetworkTab()
        {
            ...
            GcCleanupEnabledCheckbox.OnToggled += OnPredictToggled; // Lua
            GcCleanupIntervalSlider.OnValueChanged += OnSliderChanged; // Lua
        ...
        private void OnApplyButtonPressed(BaseButton.ButtonEventArgs args)
        {
            ...
            _cfg.SetCVar(CCVars.ClientGCEnabled, GcCleanupEnabledCheckbox.Pressed); // Lua
            _cfg.SetCVar(CCVars.ClientGCIntervalMinutes, (int)GcCleanupIntervalSlider.Value); // Lua
        ...
        private void OnDefaultButtonPressed(BaseButton.ButtonEventArgs obj)
        {
            ...
            GcCleanupEnabledCheckbox.Pressed = CCVars.ClientGCEnabled.DefaultValue; // Lua
            GcCleanupIntervalSlider.Value = CCVars.ClientGCIntervalMinutes.DefaultValue; // Lua
        ...
        private void Reset()
        {
            ...
            GcCleanupEnabledCheckbox.Pressed = _cfg.GetCVar(CCVars.ClientGCEnabled); // Lua
            GcCleanupIntervalSlider.Value = _cfg.GetCVar(CCVars.ClientGCIntervalMinutes); // Lua
            UpdateChanges();
        }
        ...
        private void UpdateChanges()
        {
            ...
            GcCleanupIntervalLabel.Text = ((int)GcCleanupIntervalSlider.Value).ToString(CultureInfo.InvariantCulture); // Lua
