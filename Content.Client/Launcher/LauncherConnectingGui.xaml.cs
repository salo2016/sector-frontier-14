...
namespace Content.Client.Launcher
{
    ...
    public sealed partial class LauncherConnectingGui : Control
    {
            ...
            IPrototypeManager prototype, IConfigurationManager config, IClipboardManager clipboard)
        {
            ...
            VersionLabel.Text = FormatBuildVersion(config);
            ChangeLoginTip();
        ...
        private static string FormatBuildVersion(IConfigurationManager cfg)
        {
            var engineVersion = cfg.GetCVar(CVars.BuildEngineVersion);
            var buildVersion = cfg.GetCVar(CVars.BuildVersion);
