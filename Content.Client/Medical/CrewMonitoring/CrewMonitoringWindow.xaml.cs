...
public sealed partial class CrewMonitoringWindow : FancyWindow
{
    ...
    public CrewMonitoringWindow()
    {
        ...
        AliveFilterCheckBox.OnToggled += _ =>
        {
            _showAlive = AliveFilterCheckBox.Pressed;
            RefreshSensorsView();
        };
        CriticalFilterCheckBox.OnToggled += _ =>
        {
            _showCritical = CriticalFilterCheckBox.Pressed;
            RefreshSensorsView();
        };
        DeadFilterCheckBox.OnToggled += _ =>
        {
            _showDead = DeadFilterCheckBox.Pressed;
            RefreshSensorsView();
        };
    }
