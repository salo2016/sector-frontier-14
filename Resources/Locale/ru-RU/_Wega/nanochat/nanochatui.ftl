...
nano-chat-ui-insert-address-tooltip = Вставить адрес звёздных врат (напр. [stargate size=20]E P U X S l[/stargate])
nano-chat-ui-discovery-title = Найти контакты
nano-chat-ui-discovery-tooltip = Общий список
nano-chat-ui-discovery-hint = Здесь отображаются игроки, включившие «Виден в списке». Добавьте их в контакты.
nano-chat-ui-discovery-empty = Сейчас в списке никого нет.
nano-chat-ui-visible-in-discovery-tooltip = Виден в списке поиска
