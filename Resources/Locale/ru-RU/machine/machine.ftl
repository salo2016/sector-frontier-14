...
#machine-upgrade-increased-by-percentage = Параметр [color=yellow]{ $upgraded }[/color] увеличен на { $percent }%. # Lua
#machine-upgrade-decreased-by-percentage = Параметр [color=yellow]{ $upgraded }[/color] уменьшен на { $percent }%. # Lua
...
#machine-upgrade-not-upgraded = Параметр [color=yellow]{ $upgraded }[/color] не улучшался. # Lua
