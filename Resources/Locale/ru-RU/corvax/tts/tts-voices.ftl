...
tts-voice-name-servo_skull = Сервочереп
...
tts-voice-name-mission_control = Центр управления
tts-voice-name-male_v = В (муж.)
tts-voice-name-sobchak = Собчак
tts-voice-name-haru = Хару
tts-voice-name-chairon = Харон
tts-voice-name-snipertf = Снайпер (TF2)
tts-voice-name-berserk = Берсерк
tts-voice-name-joshua = Джошуа
tts-voice-name-last_years_snow_narrator = Рассказчик (Снег прошлых лет)
tts-voice-name-machine_spirit_4 = Машинный дух 4
tts-voice-name-gadriel = Гадриэль
tts-voice-name-placide = Пласид
tts-voice-name-acheran = Ахеран
tts-voice-name-dwarves = Дворфы
tts-voice-name-last_years_snow_man = Снежный человек (Снег прошлых лет)
tts-voice-name-joel = Джоэл
tts-voice-name-takemura = Такэмура
...
tts-voice-name-saul = Сол
tts-voice-name-balthazar = Бальтазар
