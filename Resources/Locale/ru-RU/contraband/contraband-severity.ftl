...
contraband-examine-text-Restricted = [color=yellow]Этот предмет имеет ведомственное ограничение.[/color]
contraband-examine-text-Restricted-department = [color=yellow]Этот предмет доступен только для { $departments }, он может считаться контрабандой.[/color]
