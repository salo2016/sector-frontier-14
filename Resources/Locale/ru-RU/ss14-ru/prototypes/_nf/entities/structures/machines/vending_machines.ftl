...
ent-VendingMachineNfsdDrobe = СРБСдроб
    .desc = Элитная экипировка для сотрудников СРБС! Будьте в авангарде моды и безопасности с лучшей формой и снаряжением для защитников порядка.
...
ent-VendingMachineNfsdTech = СРБСтех
