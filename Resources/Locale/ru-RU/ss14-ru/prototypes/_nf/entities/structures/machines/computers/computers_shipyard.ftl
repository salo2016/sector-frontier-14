...
ent-ComputerShipyardSecurity = консоль приёма в СРБС
    .desc = Откройте для себя путь в элиту безопасности! Эта консоль позволяет вам вступить в Службу Разведки и Безопасности Сектора, обеспечив вас надежным шаттлом для патрулирования галактики. Станьте частью героической команды защитников и держите космическое пространство в безопасности.
ent-ComputerShipyardNfsd = консоль верфи СРБС
    .desc = Здесь вы можете приобрести патрульные шаттлы СРБС, оснащенные новейшими технологиями и готовые к самым сложным заданиям. Поддержите закон и порядок среди звезд, используя надежные и мощные шаттлы, созданные для настоящих героев.
...
ent-ComputerShipyardSr = консоль верфи Директора Исследований
