...
ent-JetInjector = джет-инъектор
    .desc = Стерильный инъектор для удобного введения лекарств пациентам.
ent-AdvancedJetInjector = продвинутый джет-инъектор
    .desc = Высококачественный джет-инъектор с более быстрой инъекцией и увеличенной емкостью.
ent-AdvancedJetInjectorNfsd = джет-инъектор СРБС
    .desc = Высококачественный джет-инъектор с более быстрой инъекцией и увеличенной емкостью, имеющий отличительные знаки военного назначения.
ent-AdvancedJetInjectorSC = Ржавый джет-инъектор
    .desc = Старый джет-инъектор, покрытый грязью, пылью и ржавчиной, однако не потерявший своего качества и работоспособности.
ent-VipJetInjector = премиум джет-инъектор
    .desc = Премиальный вариант продвинутого джет-инъектора.
