...
using Content.Shared._White.Standing; // WD EDIT
using Robust.Shared.Containers; // WD EDIT
...
public abstract partial class SharedStunSystem
{
    ...
    // WD EDIT: Dependencies already declared in main SharedStunSystem.cs file
    ...
    {
        // WD EDIT START: Use LayingDown system if available
        RaiseNetworkEvent(new CheckAutoGetUpEvent(GetNetEntity(entity)));
        _layingDown.TryLieDown(entity, null, null, DropHeldItemsBehavior.DropIfStanding);
        // WD EDIT END
