...
namespace Content.Shared.Showers
{
    ...
    public sealed partial class ShowerComponent : Component
    {
        ...
        public SoundSpecifier EnableShowerSound = new SoundPathSpecifier("/Audio/_Lua/Ambience/Objects/shower_enable.ogg"); //Lua

        public EntityUid? PlayingStream;

        [DataField("loopingSound")]
        public SoundSpecifier LoopingSound = new SoundPathSpecifier("/Audio/_Lua/Ambience/Objects/shower_running.ogg"); //Lua
