...
public sealed class StandingStateSystem : EntitySystem
{
    ...
    {
        if (entity.Comp.CurrentState == StandingState.Standing)
            return;
    ...
    public bool IsDown(Entity<StandingStateComponent?> entity)
    {
        ...
        return entity.Comp.CurrentState is StandingState.Lying or StandingState.GettingUp;
    }
        ...
        HandsComponent? hands = null)
    {
        ...
        standingState.Standing = false; // Sync with upstream bool field
        ...
        bool force = false)
    {
        ...
        standingState.Standing = true; // Sync with upstream bool field
        Dirty(uid, standingState);
