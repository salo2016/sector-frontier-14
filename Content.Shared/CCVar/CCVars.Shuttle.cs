...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<bool> ImpactEnabled =
        CVarDef.Create("shuttle.impact.enabled", true, CVar.SERVERONLY); // Lua false<true Frontier true>false
    ...
    public static readonly CVarDef<float> ImpactDamageMultiplier =
        CVarDef.Create("shuttle.impact.damage_multiplier", 0.00005f, CVar.SERVERONLY); // Frontier 0.00005f>0.00001f
    ...
    public static readonly CVarDef<float> ImpactInertiaScaling =
        CVarDef.Create("shuttle.impact.inertia_scaling", 0.5f, CVar.SERVERONLY); // Frontier 0.5f>0.025f
